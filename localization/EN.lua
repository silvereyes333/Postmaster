...
POSTMASTER_STRINGS = {
    ...
    ["SI_PM_PLAYER_TAKE_RETURNED_TOOLTIP"]       = "When this option is enabled, the <<1>> command takes the attachments from and deletes any mail returned to you by another player.",
    ...
    ["SI_PM_HELP_04"]                            = "<<1>> takes attachments and deletes |cEFEBBEall|r of the following mail:",
