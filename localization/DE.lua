...
local strings = {
    ...
    ["SI_PM_RETURN_DIALOG_SUPPRESS"]             = "Rücksendungbestätigung unterdrücken",
    ...
    ["SI_PM_BOUNCE_MESSAGE"]                     = { "Nachricht Rückkehr zu <<1>>", POSTMASTER_STRING_NO_FORMAT },
    ...
    ["SI_PM_PLAYER_TAKE_RETURNED"]               = "Nachrichten zurückgegeben",
