...
local strings = {
    ...
    ["SI_PM_SYSTEM_ATTACHED"]                    = "Systemnachrichten mit Anhang",
    ["SI_PM_SYSTEM_ATTACHED_TOOLTIP"]            = "<<1>> entnimmt alle Anhänge von Systemnachrichten und löscht anschliessend die Nachricht, inklusive PvP- und Handwerksnachrichten.",
    ["SI_PM_SYSTEM_ATTACHED_TOOLTIP_QUICK"]      = { "<<1>> entnimmt alle Anhänge von Systemnachrichten und löscht anschliessend die Nachricht, inklusive PvP- und Handwerksnachrichten.", SI_PM_TAKE },
    ...
    ["SI_PM_PLAYER_TAKE_RETURNED_TOOLTIP"]       = "Wenn diese Option aktiviert ist wird <<1>> die Anhänge von jeder an dich zurückgeschickten Spielernachricht entnehmen und die Nachricht löschen.",
