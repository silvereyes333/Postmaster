...
local strings = {
    ...
    ["SI_PM_SYSTEM_ATTACHED"]                    = "添付アイテムありのシステムメール",
    ["SI_PM_SYSTEM_ATTACHED_TOOLTIP"]            = "このオプションが有効化されている場合、<<1>>コマンドは添付ファイルがある雇用メールやAvAリワードメールと言ったシステムメールから添付されたファイルを取得し、削除します。",
    ["SI_PM_SYSTEM_ATTACHED_TOOLTIP_QUICK"]      = { "このオプションが有効化されている場合、<<1>>コマンドは添付ファイルがある雇用メールやAvAリワードメールと言ったシステムメールから添付されたファイルを取得し、削除します。", SI_PM_TAKE },
    ...
    ["SI_PM_PLAYER_TAKE_RETURNED_TOOLTIP"]       = "このオプションが有効化されている場合、<<1>>コマンドは他のプレイヤーから返信されてきたどのメールからも添付ファイルを受け取り、削除します。",
