...
local strings = {
    ...
    ["SI_PM_SYSTEM_ATTACHED"]                    = "Courriers systèmes avec pièces jointes",
    ["SI_PM_SYSTEM_ATTACHED_TOOLTIP"]            = "Lorsque cette option est activée , la commande <<1>> récupérera les pièces jointes et effacera les courriers concernés",
    ["SI_PM_SYSTEM_ATTACHED_TOOLTIP_QUICK"]      = { "Lorsque cette option est activée , la commande <<1>> récupérera les pièces jointes et effacera les courriers concernés", SI_PM_TAKE },
