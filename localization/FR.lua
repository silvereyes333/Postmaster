...
local strings = {
    ...
    ["SI_PM_SYSTEM"]                             = "Courrier système",
    ["SI_PM_SYSTEM_TAKE_ATTACHED"]               = "Courrier système avec pièce jointe",
    ...
    ["SI_PM_SYSTEM_DELETE_EMPTY"]                = "Courrier système vide",
    ["SI_PM_SYSTEM_DELETE_EMPTY_TOOLTIP"]        = "Lorsque cette option est activée , la commande <<1>> effacera tous les courriers vides des joueurs.",
    ["SI_PM_SYSTEM_DELETE_EMPTY_FILTER"]         = "Le courrier système vide contient",
    ...
    ["SI_PM_PLAYER_DELETE_EMPTY_FILTER_TOOLTIP"] = { "Lorsque ce filtre est pas vide , la commande <<1>> ne supprime le courrier des joueurs sans pièces jointes qui contiennent également l'un des mots ou des phrases données dans les champs de l'expéditeur , objet ou le corps. <<2>>", SI_PM_TAKE_ALL, "SI_PM_SEPARATOR_HINT" },
